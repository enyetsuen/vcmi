...
public:
	...
	void save(const std::string &fname, PlayerColor playerToNotifyOnSuccess, int autosaveCountLimit = 0, GameConnectionID connectionToReceive = GameConnectionID::INVALID);
